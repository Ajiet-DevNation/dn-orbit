    ...
    <div className="flex-1 bg-black p-8 space-y-12">
      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between border-b border-zinc-900 pb-12 gap-8">
        <div className="space-y-4">
          ...
          <h1 className="text-6xl font-black uppercase tracking-tighter leading-none">
            MEMBER<br />DIRECTORY
            <span className="block text-2xl text-zinc-700 tracking-tight mt-4">(USER_DATABASE_V2.1)</span>
          </h1>
        </div>
      ...
      <section className="space-y-4">
        <div className="flex items-center justify-between px-2">
           <div className="text-[9px] text-zinc-600 uppercase tracking-widest font-bold">DIRECTORY_LIST (ACTIVE)</div>
           <div className="flex items-center gap-4">
              <div className="text-[9px] text-zinc-800 uppercase tracking-widest font-bold">MODE: ADMINISTRATOR</div>
      ...
      <footer className="pt-12 border-t border-zinc-900 flex justify-between items-center text-[9px] text-zinc-700 uppercase tracking-[0.4em] font-bold">
         <span>©2024_DEVNATION_ORBIT</span>
         <div className="flex gap-8 text-zinc-800">
            <span>SECTOR_ADMIN</span>
